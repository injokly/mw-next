...
const Detail = () => {
  ...
  //     //document.getElementsByClassName('mob_show').removeChild();
  //     //unmountComponentAtNode(mobNode);
  //   }, [])
  // }
  useEffect(() => {
    const tick = setTimeout(() => {
      //document.getElementById('joinEvnt').remove();
      // \document.getElementsByClassName('mob_show').remove();
      // document.getElementsByClassName('pc_show').remove();
    }, 1);
  }, [cntnt])
  ...
  const createMarkup = () => {
    //useEffect(() => {
      const tick = setTimeout(() => {
        ...
        // console.log("aaa" + a);
        // a.removeChild(a.querySelecterAll(".mob_show"));

        // if(a) a.removeChild();
//        if(document.querySelector('.mob_show')) document.querySelector('.mob_show').removeChild();
        // if(document.getElementById('joinEvnt')){
        //   document.getElementById('joinEvnt').remove();
        // }
         // \document.getElementsByClassName('mob_show').remove();
        // document.getElementsByClassName('pc_show').remove();
